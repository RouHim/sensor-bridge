...
<p align="center">
    <a id="sensor-bridge-download-linux" href="https://github.com/RouHim/sensor-bridge/releases/download/0.42.4/sensor-bridge_0.42.4_amd64.AppImage"><img src=".github/readme/dl-linux.png" width="250"/></a>
</p>
...
- `GET /health` - Server health check and protocol version
